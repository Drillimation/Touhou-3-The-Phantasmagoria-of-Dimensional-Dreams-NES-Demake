...
scr_cutscene(6,spr_chiyuri_06);
scr_cutscene(7,spr_chiyuri_06);
...
scr_cutscene(14,spr_chiyuri_07);
scr_cutscene(15,spr_chiyuri_07);
scr_cutscene(16,spr_whack);
scr_cutscene(17,spr_chiyuri_10);
scr_cutscene(18,spr_chiyuri_10);
scr_cutscene(19,spr_whack);
for (var i = 20; i < 52; i += 1) {
	scr_cutscene(i,spr_chiyuri_08);
}
scr_cutscene(52,spr_whack);
scr_cutscene(53,spr_chiyuri_10);
scr_cutscene(54,spr_chiyuri_10);
scr_cutscene(55,spr_chiyuri_10);
scr_cutscene(56,spr_chiyuri_10);
ini_close();
