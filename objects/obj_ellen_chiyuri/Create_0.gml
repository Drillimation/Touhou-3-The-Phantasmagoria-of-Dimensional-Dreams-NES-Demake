...
scr_cutscene(11,spr_chiyuri_10);
scr_cutscene(12,spr_chiyuri_10);
scr_cutscene(13,spr_whack);
for (var i = 14; i < 42; i += 1) {
	scr_cutscene(i,spr_chiyuri_08);
}
scr_cutscene(42,spr_whack);
scr_cutscene(43,spr_chiyuri_10);
scr_cutscene(44,spr_chiyuri_10);
scr_cutscene(45,spr_chiyuri_10);
scr_cutscene(46,spr_chiyuri_10);
ini_close();
