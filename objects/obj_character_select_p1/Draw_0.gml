...
if ready == false {
	...
	draw_sprite(spr_cursor_p1,0,80,y + (button_h * menu_index_y));
	draw_sprite(spr_portraits,menu_index_y,8,88)
	draw_sprite(spr_stats,menu_index_y,8,160)
